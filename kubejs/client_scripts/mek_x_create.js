...
ClientEvents.lang('en_us', event => {
	event.add('gas.kubejs.helium3', "Helium-3")
	event.add('gas.kubejs.refined_stellarite', "Refined Stellarite")
	event.add('gas.kubejs.unrefined_stellarite', "Unrefined Stellarite")
  event.add('slurry.kubejs.dirty_silica_slurry', "Dirty Silica Slurry")
	event.add('slurry.kubejs.clean_silica_slurry', "Clean Silica Slurry")
	event.add('slurry.kubejs.dirty_rare_metal_slurry', "Dirty Rare Metal Slurry")
	event.add('slurry.kubejs.clean_rare_metal_slurry', "Clean Rare Metal Slurry")
})
